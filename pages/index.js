              ...
              <div className=" container relative ">
                <div className=" flex items-center justify-center  basis-1/4 mx-auto w-full  p-3">
                  <p className=" text-2xl max-w-md font-bold text-white text-center mb-8">
                    A financial management app that helps you track and analyze
                    your financial status and plan for the future. Understand
                    your financial situation and make informed decisions about
                    your money!
                  </p>
                </div>
